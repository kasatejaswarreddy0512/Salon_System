...
import { CREATE_SALON_FAILURE, CREATE_SALON_REQUEST, CREATE_SALON_SUCCESS, FETCH_SALON_BY_ID_FAILURE, FETCH_SALON_BY_ID_REQUEST, FETCH_SALON_BY_ID_SUCCESS, FETCH_SALON_BY_OWNER_FAILURE, FETCH_SALON_BY_OWNER_REQUEST, FETCH_SALON_BY_OWNER_SUCCESS, FETCH_SALON_FAILURE, FETCH_SALON_REQUEST, FETCH_SALON_SUCCESS, SEARCH_SALON_FAILURE, SEARCH_SALON_REQUEST, SEARCH_SALON_SUCCESS, UPDATE_SALON_FAILURE, UPDATE_SALON_REQUEST, UPDATE_SALON_SUCCESS } from "./actionTypes";
...
//Update Salon
export const updateSalon = ({ slaonId, salon, jwt }) => async (dispatch) => {
...
//Feteh Salons
export const fecchSalons = () => async (dispatch) => {
