...
export const FETCH_SERVICE_BY_SALON_REQUEST = "FETCH_SERVICE_BY_SALON_REQUEST";
export const FETCH_SERVICE_BY_SALON_SUCCESS = "FETCH_SERVICE_BY_SALON_SUCCESS";
export const FETCH_SERVICE_BY_SALON_FAILURE = "FETCH_SERVICE_BY_SALON_FAILURE";
